    ...
    return (
        <section className="bg-[url('./images/234.jpg')] h-screen">
            ...
            <nav className="flex w-full justify-between p-7 border-b-2 border-slate-200">
                ...
                <div>
                    <ul className="flex w-52 justify-between font-bold text-slate-700">
                        <li className="border-2 border-slate-700 rounded-full px-3 py-1 hover:bg-slate-700 hover:text-slate-100" onClick={()=> setLogin(true)}>Sign In</li>
                        <li className="border-2 border-slate-700 rounded-full px-3 py-1 hover:bg-slate-700 hover:text-slate-100" onClick={()=>setRegister(true)}>Sign Up</li>
                    </ul>
                </div>
            </nav>
            <div className="flex h-[42%] border-x-2 border-slate-100 ml-[10%] mr-[10%]">
                <div className="pt-40 md:pt-40 w-[70%]">
                    <p className="typewriter font-bold font-mono pl-5 text-slate-700" style={{ fontSize: '3rem' }}>World Wide <br/> Weather Forecast Is Here</p>
                </div>
